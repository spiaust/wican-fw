...
4. Connect the WiCAN PRO device to your vehicle's OBD port for power, then plug in the USB cable. The WiCAN PRO cannot be powered via the USB-C connector. Two COM ports should appear in your device manager — use `Serial-A`.  
